...
const Order = () => {
    ...
    const fetchOrders = async () => {
      ...
      try {
        const response = await fetch(
          `https://local-grocery-back-end.vercel.app/orders?customer_id=${customer._id}`
        );
  ...
  const handleDeleteOrder = async (orderId) => {
    ...
    try {
      const response = await fetch(`https://local-grocery-back-end.vercel.app/orders/${orderId}`, {
        method: "DELETE",
      });
